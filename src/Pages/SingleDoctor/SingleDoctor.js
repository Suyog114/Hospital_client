...
function SingleDoctor() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async () => {
      ...
      try {
        const res = await axios.post(`${API_URL}/patient/addDetails`, data)
  ...
  useEffect(() => {
    axios.get(`${API_URL}/doctor/getOneDoctor/${id}`).then(res => setOneDoctor(res.data)).catch(err => console.log(err))
  }, [])
