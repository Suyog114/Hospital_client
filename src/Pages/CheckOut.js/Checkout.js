  ...
  let config = {
    ...
    "eventHandler": {
      async onSuccess(payload) {
        ...
        const res = await axios.post(`${API_URL}/order/addOrder`, { ...orderData, ['order_payment']: paymentOption, ['totalAmount']: (_.sum(totalPrice) + delivery) })
        await axios.post(`${API_URL}/payment/addPayment`, {
        ...
        await axios.delete(`${API_URL}/cart/deleteAllCart`)
